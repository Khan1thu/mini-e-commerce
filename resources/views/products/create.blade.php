...
@section('content')
<form  action="/products/" method="POST" class="d-flex flex-column justify-content-center align-items-center background-color:red;" enctype="multipart/form-data">
    {{csrf_field()}}
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="brand" id="brand" placeholder="Enter your brand">
    </div>
